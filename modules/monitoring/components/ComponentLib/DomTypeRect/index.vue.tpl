  ...
  <div class="tab-content">
    ...
    <div class="tab-pane" id="tab_4">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <input type="input" class="form-control" v-model='rx' placeholder="eg:12px">
        </div>
      </div>
      <div class="form-group">
        <label class="col-sm-3 control-label">ry</label>
        <div class="col-sm-9">
          <input type="input" class="form-control" v-model='ry' placeholder="eg:12px">
        </div>
      </div>
      <div class="clearfix">
        <button class="btn btn-info pull-right" v-on:click='ok'>确认</button>
